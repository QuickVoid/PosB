...
def is_collinear(p1,p2,p3):
    """is_collinear(p1,p2,p3) returns True of p1, p2 and p3 lay on a straight line (i.e. they are collinear), else returns False."""
...
def nearest_points(*pairs):
    """nearest_points(*pairs) returns a list with indices 0 or 1 indicating which of the two points in all pairs are closest to each other. Used in trilateration problems to find the corresponding solutions in multiple pairs."""
